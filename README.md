...
- Optimal resolution is 1024x1024 pixels (minimum 350x350 pixels)
...
It's best to upload photos where you are the only person visible. If you have group photos, you'll have the opportunity to crop and select just your face during the photo verification process. However, using solo photos from the start is ideal.
...
For the most accurate results, use recent photos that reflect your current appearance. If your look changes significantly (e.g., new hairstyle, facial hair changes), consider updating your model with new photos.
...
Tokens will expire after 4 months of inactivity.
